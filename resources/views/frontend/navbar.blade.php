<nav x-data="{ 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" @mouseleave="activeMenu = null">
        <!-- Search Bar Overlay -->
        ...
        <div class="flex justify-between items-center h-16 relative">
            ...
            <div class="hidden md:flex md:items-center md:space-x-8 flex-1 justify-center relative">
                <!-- Men Menu -->
                <button @mouseenter="activeMenu = 'men'"
            ...
            <div x-show="activeMenu === 'men'" x-cloak
                class="absolute top-full left-0 right-0 w-full bg-white shadow-xl py-8 px-4 border-t border-gray-100 rounded-md"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-x-6 gap-y-3">
                            ...
                            <div class="relative group">
                                <button class="w-full text-left text-gray-700 hover:text-indigo-600">Footwear</button>
                            </div>
                            <div class="relative group">
                                <button
                            ...
                            <div class="relative group">
                                <button class="w-full text-left text-gray-700 hover:text-indigo-600">Sportswear</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="#"
                                ...
                                <img src="{{ asset('images/nike.png') }}" class="h-10 w-fit object-contain scale-150"
                                    alt="Nike">
                            </a>
                            <a href="#"
                                class="p-1 bg-gray-50 hover:bg-gray-100 rounded-lg flex items-center justify-center">
                                <img src="{{ asset('images/adidas.png') }}" class="h-10 w-fit object-contain scale-150"
                                    alt="Adidas">
                            </a>
                            <a href="#"
                                class="p-1 bg-gray-50 hover:bg-gray-100 rounded-lg flex items-center justify-center">
                                <img src="{{ asset('images/puma.png') }}" class="h-10 w-fit object-contain scale-150"
                                    alt="Puma">
                            </a>
                            <a href="#"
                                class="p-1 bg-gray-50 hover:bg-gray-100 rounded-lg flex items-center justify-center">
                                <img src="{{ asset('images/levis.png') }}" class="h-10 w-fit object-contain scale-150"
                                    alt="Levi's">
                            </a>
                        </div>
                    </div>
